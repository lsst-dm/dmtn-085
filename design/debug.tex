...
\begin{itemize}
  ...
  and awkward to use, and developers lack appropriate guidelines on how to
  embed debugging information into algorithms or on how to use that information
  to most effectively debug running pipelines.}
